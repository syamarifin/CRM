...
Partial Class iPxCrmUser_iPxCrmHome
    ...
    Public Shared Function notifTotalTicketNew() As String
        Dim Possition = HttpContext.Current.Session("sPossition").ToString()
        Dim ProductCode = HttpContext.Current.Session("sProductCode").ToString()
        Dim idUSer = HttpContext.Current.Session("sId").ToString()
    ...
    End Function
    <System.Web.Services.WebMethod()> _
    Public Shared Function notifTotalTicketFollow() As String
        Dim Possition = HttpContext.Current.Session("sPossition").ToString()
        Dim ProductCode = HttpContext.Current.Session("sProductCode").ToString()
        Dim idUSer = HttpContext.Current.Session("sId").ToString()
        Dim Order As New List(Of Object)()
        ...
        Using conn As New SqlConnection()
            ...
            Using cmd As New SqlCommand()
                If Possition = "0" Then
                    sSQL = "SELECT  count(isRead) as jumlahFollow FROM SPR_eticketFollowUp INNER JOIN SPR_eticket ON SPR_eticket.TicketNo=SPR_eticketFollowUp.TicketNo INNER JOIN CFG_productGrp ON SPR_eticket.ProductGrp = CFG_productGrp.ProductGrp where FollowUpDate in ( SELECT max(FollowUpDate) FROM SPR_eticketFollowUp where SPR_eticket.statusID <> '1' and SPR_eticket.statusID < '6' and FollowUpCode ='H' and isRead='1' and SPR_eticket.AssignTo <> '" & "" & "' group by TicketNo )"
                    If Possition = "0" And ProductCode = "1" Then
                        sSQL += " "
                    ElseIf Possition = "0" And ProductCode = "2" Then
                        sSQL += " and CFG_productGrp.PrdDescription = 'Alcor'"
                    ...
                    End If
                Else
                    sSQL = "SELECT  count(isRead) as jumlahFollow FROM SPR_eticketFollowUp INNER JOIN SPR_eticket ON SPR_eticket.TicketNo=SPR_eticketFollowUp.TicketNo where FollowUpDate in ( SELECT max(FollowUpDate) FROM SPR_eticketFollowUp where SPR_eticket.statusID <> '1' and SPR_eticket.statusID < '6' and FollowUpCode ='H' and isRead='1' and SPR_eticket.AssignTo = '" & idUSer & "' group by TicketNo )"
                End If
                cmd.CommandText = sSQL
                cmd.Connection = conn
                conn.Open()
    ...
    End Function
    <System.Web.Services.WebMethod()> _
    Public Shared Function notifTotalTicketDone() As String
        Dim Possition = HttpContext.Current.Session("sPossition").ToString()
        Dim ProductCode = HttpContext.Current.Session("sProductCode").ToString()
        Dim idUSer = HttpContext.Current.Session("sId").ToString()
        Dim Order As New List(Of Object)()
        ...
        Using conn As New SqlConnection()
            ...
            Using cmd As New SqlCommand()
                If Possition = "0" Then
                    sSQL = "Select count (SPR_eticketFollowUp.isRead) as jumlahFollow from SPR_eticketFollowUp INNER JOIN SPR_eticket ON SPR_eticket.TicketNo =SPR_eticketFollowUp.TicketNo INNER JOIN CFG_productGrp ON SPR_eticket.ProductGrp = CFG_productGrp.ProductGrp where SPR_eticketFollowUp.FollowUpCode= 'H' and SPR_eticketFollowUp.isRead='" & "1" & "' and SPR_eticket.StatusID >= '6' and SPR_eticket.AssignTo <> '" & "" & "'"
                    If Possition = "0" And ProductCode = "1" Then
                        sSQL += " "
                    ElseIf Possition = "0" And ProductCode = "2" Then
                        sSQL += " and CFG_productGrp.PrdDescription = 'Alcor'"
