<%@ Page Language="VB" MasterPageFile="~/iPxCrmUser/iPxMasterUser.master" AutoEventWireup="false" CodeFile="releaseversionB.aspx.vb" Inherits="iPxCrmUser_releaseversionB" title="CRM Version" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="dvAccordian" class="panel-group" style="width: 100%;">
        <asp:GridView ID="gvReleaseVersion" runat="server" AutoGenerateColumns="false" GridLines="None" style="width: 100%;"
            DataKeyNames="MID,VID" OnRowDataBound="OnRowDataBound">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <div class="panel-heading" role="tab" id="heading<%#Eval("id")%>">
                            <h4 class="panel-title">
                                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#dvAccordian"
                                    ...
                                    <asp:Label ID="lbTitle" runat="server" Text='<%# "versi "+ Eval("verid")%>'></asp:Label>
                                </a> 
                            </h4>
                        </div>
