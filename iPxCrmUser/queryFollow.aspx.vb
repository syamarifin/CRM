...
Partial Class iPxCrmUser_queryFollow
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        If dlProductGrp.SelectedValue.Trim <> "" Then
            Session("sCondition") = Session("sCondition") & " AND (SPR_eticket.ProductGrp = '" & dlProductGrp.SelectedValue.Trim & "') "
        End If
        ...
        ElseIf dlStatus.SelectedValue.Trim = "" Then
            Session("sCondition") = Session("sCondition") & " and SPR_eticket.statusID <> '1' and SPR_eticket.statusID <> '6' and SPR_eticket.statusID <> '7' "
        End If
        ...
        If tbQSupport.Text.Trim <> "" Then
            Session("sCondition") = Session("sCondition") & " AND (CFG_user.name like '%" & Replace(tbQSupport.Text.Trim, "'", "''") & "%') "
        End If


        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "PopUser", "hideModal()", True)
        'sSQL = Session("sCondition")
        Response.Redirect("iPxCrmAssign.aspx?sCondition=" & sSQL)
    End Sub

    Protected Sub btnExit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExit.Click
        Session("sCondition") = ""
        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "PopUser", "hideModal()", True)
        Response.Redirect("iPxCrmAssign.aspx?sCondition=")
    End Sub
