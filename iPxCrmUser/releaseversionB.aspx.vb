...
Partial Class iPxCrmUser_releaseversionB
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            'Me.BindRepeater()
            sSQL = "select distinct iPx_general_ver.version as verid, iPx_general_ver.id , iPx_general_verDTL.verid as VID, iPx_general_verDTL.moduleid as MID from iPx_general_verDTL "
    ...
    Protected Sub OnRowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim moduleid As String = gvReleaseVersion.DataKeys(e.Row.RowIndex).Values("MID").ToString()
            ...
            sSQL = "select iPx_general_ver .version , iPx_general_verMDL .description , iPx_general_verDTL .note,iPx_general_verDTL.moduleid as MID from iPx_general_verDTL "
