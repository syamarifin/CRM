<%@ Page Language="VB" MasterPageFile="~/iPxCrmMobileUser/iPxMobileUpload.master" AutoEventWireup="false" CodeFile="iPxCrmInputTicketUser.aspx.vb" Inherits="iPxCrmMobileUser_iPxCrmInputTicketUser" title="Form E-Ticket" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="tbMenuID" runat="server" CssClass ="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
    ...
    <div class="row" style="margin: 20px 0 20px 20px;">
         ...
         <div class="col-md-6" style="padding-left:0px;">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="dlMenu" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="dlMenu_SelectedIndexChanged">
                    ...
                    <div class="input-group-btn">
                        <asp:LinkButton ID="lbAddMenu" class="btn btn-default" runat="server" Font-Size="Small"><span class="glyphicon glyphicon-plus" style="height:20px;"></span></asp:LinkButton>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <asp:DropDownList ID="dlSubMenu" runat="server" CssClass="form-control">
                    ...
                    <div class="input-group-btn">
                        <asp:LinkButton ID="lbAddSubmenu" class="btn btn-default" runat="server" Font-Size="Small"><span class="glyphicon glyphicon-plus" style="height:20px;"></span></asp:LinkButton>
                    </div>
                </div>
            </div>
            <div class="form-group">
         ...
         <div class="col-md-12" style="padding-left:0px;">
            ...
            <div class="form-group">
                ...
                <asp:Label ID="lbFile" runat="server" Text="Label"></asp:Label><br />
                <asp:Label ID="Label1" runat="server" Text="Max Size 10MB(.docx,.jpeg,.rar,.pdf)"></asp:Label>
            </div>
         </div>
    </div>
    <p class="text-center">
        <asp:LinkButton ID="lbSave" CssClass ="btn btn-default" runat="server" Width="100px" OnClientClick="showWaitingMessage()" ><i class="fa fa-send"></i> Send</asp:LinkButton>
        <asp:LinkButton ID="lbDelete" CssClass ="btn btn-default" runat="server" Width="100px"><i class="fa fa-trash-o"></i> Delete</asp:LinkButton>
    </p>
</asp:Content>
