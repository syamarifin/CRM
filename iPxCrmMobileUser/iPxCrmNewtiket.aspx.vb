...
Partial Class iPxCrmMobileUser_iPxCrmNewtiket
    ...
    Sub Userid()
        ...
        ElseIf Session("sPossition") = "0" And Session("sProductCode") = "2" Then
            sSQL += " AND dept = 'SPR' AND ProductCode = '2'"
    ...
    Protected Sub gvTicket_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvTicket.RowCommand
        If e.CommandName = "getTiketid" Then
            ...
            'usercode, mobileno, password, signupdate, fullname, status, quid
            If oSQLReader.HasRows Then
                Session("StbTicketno") = oSQLReader.Item("TicketNo").ToString
                Session("StbHotelName") = oSQLReader.Item("CustName").ToString 'nama Hotel
                Session("StbContact") = oSQLReader.Item("Phone").ToString 'contact Hotel
        ...
        ElseIf e.CommandName = "getEditTiket" Then
            ...
            End If
            oSQLCmd = New SqlCommand(sSQL, oCnct)
            sSQL = "SELECT * FROM SPR_eticket INNER JOIN CFG_customer on CFG_customer.CustID = SPR_eticket.CustID WHERE TicketNo = '" & i & "'"
            oSQLCmd.CommandText = sSQL
            oSQLReader = oSQLCmd.ExecuteReader
            ...
            If oSQLReader.HasRows Then
                ...
                Session("sIn7") = oSQLReader.Item("CustName").ToString
                Session("sIn8") = oSQLReader.Item("Phone").ToString
    ...
    Protected Sub lbSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbSave.Click
        ...
        sSQL = sSQL & "WHERE TicketNo = '" & Session("StbTicketno") & "' "
        ...
        If Session("sEmailfrom") <> "" Then
            ...
            bodysupport += "<br/>"
            bodysupport += "<br/>Ticket No    : <strong>" + Session("StbTicketno") + "</strong> "
            bodysupport += "<br/>Hotel Name   : <strong>" + Session("StbHotelName") + "</strong>"
            ...
            bodyclient += "<br/>Ticket No    : <strong>" + Session("StbTicketno") + "</strong> "
            bodyclient += "<br/>Hotel Name   : <strong>" + Session("StbHotelName") + "</strong>"
