<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/iPxCrmMobileUser/iPxMobileOprBck.master" CodeFile="queryFollowDone.aspx.vb" title="Customer Relationship Management" Inherits="iPxCrmMobileUser_queryFollowDone" %>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <div class="form-group center">
                <asp:LinkButton width=100px CssClass="btn btn-default dropdown-toggle" data- ID="btnLogin" runat="server"><span class="fa fa-filter "></span> Query</asp:LinkButton>    
                <asp:LinkButton width=100px CssClass="btn btn-default dropdown-toggle" data- ID="btnExit" runat="server"><span class="fa fa-close"></span> Abort</asp:LinkButton> 
            </div>         
