<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/iPxCrmMobile/iPxMobileOpr.master" CodeFile="warningmsg.aspx.vb" Inherits="iPxCrmMobile_warningmsg" Title="Message" %>
...
<div class="container">
  ...
  <div class="modal fade"  id="getuser" role="dialog">
    ...
    <div class="form-group col-md-6 col-sm-6 col-xs-6">
            ...
            <asp:Button ID="btnCancelonly" runat="server" class="btn btn-block btn-warning" 
                Text="CANCEL" />
    </div>
    </div> 
    </div>
