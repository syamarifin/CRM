...
Partial Class iPxCrmMobile_iPxCrmProffile
    ...
    Protected Sub lbSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbSave.Click
        ...
        Else
            ...
            oSQLCmd = New SqlCommand(sSQL, oCnct)
            'Dim dateBirthday As Date = Date.ParseExact(tbBirthday.Text, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture)
            ...
            End If
            sSQL = "UPDATE  CFG_customerContact SET  "
            sSQL += "ContactGrpID='" & dlContactGrp.SelectedValue & "',Name='" & Replace(tbNameContact.Text, "'", "''") & "',Phone='" & Replace(tbPhone.Text, "'", "''") & "',Email='" & Replace(tbEmail.Text, "'", "''") & "',Birthday='" & Replace(dateBirthday, "'", "''") & "'"
