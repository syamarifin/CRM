...
Partial Class iPxCrmMobile_iPxCrmFormTicket
    ...
    Sub savedata()
        ...
        sSQL = sSQL & "VALUES ('" & Session("sCId") & "','" & tbTicketno.Text & "','" & regDate & "','" & Session("sCEmail") & "','" & Replace(tbFrom.Text, "'", "''") & "','" & Replace(tbSubject.Text, "'", "''") & "','" & Session("sCEmail") & "','" & "ETICKET" & "','" & dlPrdGrp.SelectedValue & "','" & dlProduct.SelectedValue & "','" & dlMenu.SelectedValue & "','" & dlSubMenu.SelectedValue & "', "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Not Me.IsPostBack Then
                ...
                Else
                    productGrp()
                    dlPrdGrp.SelectedValue = Session("sCIn8")
                    product()
