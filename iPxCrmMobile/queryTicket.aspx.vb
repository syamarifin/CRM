...
Partial Class iPxCrmMobile_queryTicket
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        If dlProduct.SelectedValue.Trim <> "" Then
            Session("sCCondition") = Session("sCCondition") & " AND (SPR_eticket.ProductID = '" & dlProduct.SelectedValue.Trim & "') "
        End If

        If dlMenu.SelectedValue.Trim <> "" Then
            Session("sCCondition") = Session("sCCondition") & " AND (SPR_eticket.MenuID = '" & dlMenu.SelectedValue.Trim & "') "
        End If

        If dlSubMenu.SelectedValue.Trim <> "" Then
            Session("sCCondition") = Session("sCCondition") & " AND (SPR_eticket.SubmenuID = '" & dlSubMenu.SelectedValue.Trim & "') "
        End If
