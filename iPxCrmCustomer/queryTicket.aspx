<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/iPxCrmCustomer/iPxCrmCustomer.master" CodeFile="queryTicket.aspx.vb" title="E-Ticket" Inherits="iPxCrmCustomer_queryTicket" %>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
           ...
           <div class="col-sm-6">
            ...
            <label for="" style="text-align:right;"  class="col-sm-4">Status E-Ticket</label>
            <div class="col-sm-6">
               	<asp:DropDownList class="form-control padding-horizontal-15" id="dlStatus"  runat="server">
               	</asp:DropDownList>
               	<%--<asp:TextBox ID="TextBox1" runat="server" class="form-control padding-horizontal-15" ></asp:TextBox>--%>
               </div>         
            <br />
            <br />
